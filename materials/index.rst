...
| Day | Topics                                                      |
+=====+=============================================================+
| 1   | Introduction to Linux, working on the command line,         |
|     | working on remote computers.                                |
+-----+-------------------------------------------------------------+
| 2   | Working with HTS data, evaluation of data quality,          |
|     | data filtering                                              |
+-----+-------------------------------------------------------------+
| 3   | Genome assembly, evaluation, Metagenome cleaning            |
+-----+-------------------------------------------------------------+
| 4   | Transcriptome assembly, differential gene expression        |
|     | analysis                                                    |
+-----+-------------------------------------------------------------+
| 5   | Genome annotation, Orthology, Phylogenomics                 |
+-----+-------------------------------------------------------------+
| 6   | Working on individual project                               |
+-----+-------------------------------------------------------------+
| 7   | Working on individual project                               |
+-----+-------------------------------------------------------------+
| 8   | Working on individual project                               |
+-----+-------------------------------------------------------------+
